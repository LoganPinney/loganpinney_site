    ...
    return (
      <section className="max-w-4xl mx-auto py-16 px-4 space-y-10">
        ...
        <p className="text-gray-600 text-center max-w-2xl mx-auto">
          ...
          consulting on world-building or Web3, I can help.
        </p>
        ...
        <div className="space-y-8">
          <div className="border rounded-lg p-6 shadow hover:shadow-md transition">
            ...
            <p className="text-gray-700 mt-2">
              Custom-tailored guidance for students, creators, or professionals learning Unreal Engine, world building, or Web3 development. Flexible scheduling and project-based mentorship.
            </p>
          </div>
          ...
          <div className="border rounded-lg p-6 shadow hover:shadow-md transition">
            ...
            <p className="text-gray-700 mt-2">
              Available for 3–6 month contract work in Unreal Engine, game development, 3D animation, or Web3 app integration. Includes high-end prototyping, design, optimization, and support.
            </p>
          </div>
        </div>
