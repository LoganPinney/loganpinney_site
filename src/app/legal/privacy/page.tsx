    ...
    <div className="max-w-3xl mx-auto px-6 sm:px-8 py-20">
      ...
      <div className="space-y-6 leading-relaxed" style={{ color: '#ccc' }}>
        <section>
          ...
          <p>
            This privacy policy describes how loganpinney.com (the
            &quot;Site&quot;) handles information about visitors. The Site is
            intentionally minimal — there is no analytics tracking, no
            advertising, and no newsletter.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            If you submit the contact form, the name, email address, and message
            you provide are sent via Formspree to my email inbox. This
            information is used solely to respond to your message.
          </p>
          <p className="mt-3">
            Standard server logs (maintained by the hosting provider) may
            include IP addresses and request metadata for security and
        ...
        <section>
          ...
          >
            ...
            <li className="flex gap-2">
              ...
              <span>
                <strong>Formspree</strong> — contact form handling
              </span>
            </li>
            <li className="flex gap-2">
              <span style={{ color: 'var(--accent)' }} aria-hidden>
              ...
              <span>
                <strong>Google Fonts</strong> — font delivery (self-hosted via
                Next.js)
              </span>
            </li>
          </ul>
        ...
        <section>
          ...
          <p>
            You can request deletion of any personal information you&apos;ve
            sent via the contact form by emailing{' '}
            <a
