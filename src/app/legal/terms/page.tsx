    ...
    <div className="max-w-3xl mx-auto px-6 sm:px-8 py-20">
      ...
      <div className="space-y-6 leading-relaxed" style={{ color: '#ccc' }}>
        <section>
          ...
          <p>
            By accessing or using loganpinney.com (the &quot;Site&quot;), you
        ...
        <section>
          ...
          <p>
            The Site is provided for informational purposes and as a portfolio
            of professional work. Content may be updated, modified, or removed
        ...
        <section>
          ...
          <p>
            All content on this Site — including text, graphics, code samples,
            and design — is the intellectual property of{' '}
            {siteConfig.identity.name} unless otherwise indicated. Reproduction,
            redistribution, or commercial use without prior written consent is
            prohibited.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            kind. No guarantee is made regarding the accuracy, completeness, or
        ...
        <section>
          ...
          <p>
            ...
            provided for convenience only. I am not responsible for the content
