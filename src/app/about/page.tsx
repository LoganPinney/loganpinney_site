...
export default function AboutPage() {
    return (
      <section className="max-w-4xl mx-auto py-16 px-4 space-y-6">
        ...
        <p className="text-gray-600">
          ...
          animating environments, or developing intelligent systems.
        </p>
        ...
        <div className="bg-gray-100 p-6 rounded-lg shadow mt-8 text-sm text-gray-500">
          <p>
            🎯 Goal: Build scalable tools and experiences that generate $1M+ in annual revenue while staying creatively and technically fulfilled.
          </p>
        </div>
      </section>
    )
